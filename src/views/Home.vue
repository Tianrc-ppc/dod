<template>
  <div class="main-container">
    <n-p class="upper-title" :style="{ fontSize: states.width / 9 + 'px' }">Hands Free</n-p>
    <n-p class="lower-title" :style="{ fontSize: states.width / 6 + 'px' }">Doddle Jump</n-p>
    ...
    <img :src="buttonGamingUrl" class="game-button" @click="$router.push('game')" />
...
import buttonGamingUrl from '@/assets/buttons/play.png';
